...
- **~~Account deletion / soft-delete cascade~~** — v3.docx §2.1.5 puts this **in scope** for S1 (see task #7 below). Only the room-level cascade ("owner's rooms + their messages/files deleted") is deferred to S2, since rooms don't exist yet.
